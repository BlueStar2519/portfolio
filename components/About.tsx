              ...
              >
                ...
                <span className="text-gray-300">
                  ...
                  {line.content.includes('role:') && (
                    <>
                      {'  '}<span className="text-cyan-400">role</span>{': '}<span className="text-green-400">&quot;Senior Full Stack Developer&quot;</span>,
                    </>
                  )}
                  {line.content.includes('experience:') && (
                    <>
                      {'  '}<span className="text-cyan-400">experience</span>{': '}<span className="text-green-400">&quot;4+ years&quot;</span>,
                    </>
                  )}
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            4+ years of experience building modern web applications with a
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="space-y-4 text-gray-300 leading-relaxed">
                <p>
                  I&apos;m a Senior Full Stack Developer with nearly{" "}
                  <span className="text-white font-semibold">
                    4+ years of professional experience
                  </span>{" "}
                  building modern web applications. I specialize in creating{" "}
                  <span className="text-primary-300 font-medium">SaaS products</span> and{" "}
                  <span className="text-primary-300 font-medium">high-traffic web apps</span>{" "}
